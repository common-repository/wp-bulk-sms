...
class WBS_SMS_TO_Privacy {
	...
	public static function privacy_meta_html_gdpr() {
		echo '<p style="text-align: center;"><img src="' . esc_html(WBS_WP_SMS_TO_BULK_URL) . '/assets/images/gdpr.png" alt="GDPR"></p>';
		echo '<p class="text-lead">';
		echo sprintf( __( 'According to Article 17 GDPR, the user (data subject) shall have the right to obtain his/her data or have them erased and forgotten. In WP - Bulk SMS - by SMS.to plugin you can export the user\'s data or erase his/her data in the case she/he asks. For more information, read %1$sArticle 17 GDPR%2$s.%3$s Note: In this page you can export or delete only the user data related to WP - Bulk SMS - by SMS.to plugin. For doing the same for your whole WordPress, see the "Export Personal Data" or "Erase Personal Data" pages.', 'wp-sms-to-bulk' ), '<a href="' . esc_url( 'https://gdpr-info.eu/art-17-gdpr/' ) . '" target="_blank" style="text-decoration: none; color:#ff0000;">', '</a>', '<br />' ) . "\n";
		echo '</p>';
	}
	...
	public static function privacy_meta_html_export() {
        ...
        <form method="post" action="">
            <div id="universal-message-container">
                <div class="options">
                    <p>
                        <label><?php _e( 'User’s Mobile Number', 'wp-sms-to-bulk' ); ?></label>
                        <br/>
            ...
            <input type="hidden" name="sms_to_bulk_nonce_privacy" value="<?php echo esc_html(wp_create_nonce( 'sms_to_bulk_nonce_privacy' )); ?>">
        </form>
        <div class="clear"></div>
		<?php
	}
	...
	public static function privacy_meta_html_delete() {
        ...
        <form method="post" action="">
            <div id="universal-message-container">
                <div class="options">
                    <p>
                        <label><?php _e( 'Enter User’s Mobile Number', 'wp-sms-to-bulk' ); ?></label>
                        <br/>
                        <input type="tel" name="mobile_phone-number-delete" value=""/>
                        <br/>
                        <span class="description"><?php _e( 'Note: You cannot undo these actions.', 'wp-sms-to-bulk' ); ?></span>
                    </p>
